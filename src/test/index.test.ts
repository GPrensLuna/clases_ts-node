import { nombre, edad, saludar, esMayorDeEdad } from "../index";

test("saludar devuelve la cadena correcta", () => {
...
test("esMayorDeEdad devuelve true para edades mayores o iguales a 18", () => {
    expect(esMayorDeEdad(20)).toBe(true);
    expect(esMayorDeEdad(18)).toBe(true);
});

test("esMayorDeEdad devuelve false para edades menores a 18", () => {
